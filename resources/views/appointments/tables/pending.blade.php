    ...
    <tbody>
      @foreach($pendingAppointments as $appointment)
        <tr>
          ...
          <td>
            @if( $role=='admin')
              <a  class="btn btn-sm btn-primary"  title="Ver Turno"
            ...
            <form action=" {{ url('/appointments/'.$appointment->id.'/cancel')}}" method="POST" class="d-inline-block">
              @csrf              
              <button type="submit" class="btn btn-sm btn-danger" data-toggle="tooltip" title="Cancelar Turno"><i class="ni ni-fat-delete"></i></button>
            </form>
            @endif
          </td>
        <tr>
