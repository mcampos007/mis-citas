...
Creemos importante destacar que los servicios de INFOCAM SAS y cada una de sus plataformas están destinados a usuarios ubicados en aquellos países en los que INFOCAM SAS tenga presencia u operación, por ejemplo, mediante un Sitio Web específico para un país determinado.</p>

<p class="display-3">2. ¿Quién es el responsable del tratamiento de la Información Personal?</p>

<p>INFOCAM SAS es el responsable del tratamiento de los datos de los usuarios y de los visitantes de sus Plataformas a través de sus empresas subsidiarias o filiales. </p>

<p class="display-3">3. ¿Qué información recolectamos y tratamos?</p>

<p>INFOCAM SAS recolecta tu información personal para que puedas disfrutar de nuestros servicios, y poder mejorarlos de manera continua.
...
En algunos casos, esta información podría ser considerada sensible de acuerdo a la legislación aplicable. En estos casos, solicitamos tu consentimiento expreso para procesarlos.</p>

<p class="display-3">4. ¿Qué hacemos con la información que nos proporcionas directamente?</p>

<p>Cuando realiza una solicitud para recibir información sobre INFOCAM SAS o nuestros productos, recopilamos información de identidad que usted nos proporciona directamente. Esta información la utilizamos para poder responderte, brindarte más información y cumplir con la debida diligencia previa a contratar.
...
Utilizamos tus datos para enviarte encuestas y para recibir tus comentarios, reclamos o solicitudes. Esto lo hacemos para poder conocer tu experiencia como usuario y poder mejorar nuestra prestación de servicios y evaluar la efectividad con la que resolvemos tus problemas.</p>

<p class="display-3">5. ¿Qué hacemos con la información que nos proporcionas directamente al registrarte o utilizar nuestros servicios?</p>

<p>Utilizamos tus datos para entregarte la información y respaldo que nos solicitás, incluida la entrega de avisos técnicos, alertas de seguridad y mensajes administrativos y de respaldo. También la utilizamos para resolver disputas, cobrar pagos o tasas y brindarte asistencia a problemas con nuestros servicios o tu cuenta.
...
Almacenamos tus datos profesionales o relacionados con el empleo en nuestras bases de datos. Esto nos permite ofrecerte aquellos servicios que necesiten este tipo de información para funcionar correctamente.</p>

<p class="display-3">6. ¿Qué hacemos con la información que recopilamos de otras fuentes?</p>

<p>Recopilamos toda la información de verificación de antecedentes sobre vos de proveedores de verificación de antecedentes, de bases de datos públicas como el BCRA, AFIP, entre otros, y procesamos dicha información utilizando sistemas antifraude y de gestión de riesgos. Esto nos va a permitir verificar tu identidad, a realizar una verificación de crédito, prevenir el fraude y evaluar los riesgos. Esto no solo que cumple con las obligaciones legales vigentes, sino que además es una práctica internacionalmente aceptada.</p>

<p class="display-3">7. ¿Cómo compartimos la información personal?</p>

<p>El resguardo de tu privacidad es muy importante para INFOCAM SAS. Por ello, no vendemos ni comercializamos información que te identifique. Tampoco compartimos o transferimos de ningún otro modo tu información personal a terceros, salvo de la manera indicada a continuación:
...
Finalmente, INFOCAM SAS no será responsable por el uso indebido de tu información personal que haga cualquier tercero cuando sean estos terceros quienes directamente recolecten y/o traten tu información personal.</p>
 
<p class="display-3">8. ¿Por cuánto tiempo vamos a almacenar la información personal?</p>

<p>Solo almacenaremos la información personal durante el tiempo necesario para cumplir con el propósito para el que se ha recopilado, para cumplir con requisitos reglamentarios o legales, o durante el periodo de prescripción legal de posibles responsabilidades legales o contractuales. El período de tiempo que conservaremos su información será determinado, en general, por el tiempo que necesitemos esa información para proporcionarle nuestros Servicios, incluida cualquier función opcional que utilice y para brindar atención al cliente
...
Una vez concluido el lapso, los datos serán eliminados o anonimizados de manera tal que no pueda ser individualizada ninguna persona, según lo permita la normativa de cada país.</p>

 
<p class="display-3">9. Seguridad</p>

<p>En INFOCAM SAS nos esforzamos mucho para mantener tus datos seguros. Si bien creemos que tenemos un sólido sistema de seguridad, nadie puede garantizar que los hackers no podrán ingresar a nuestros sitios o robar sus datos mientras estén almacenados o siendo enviados desde usted hacia nosotros o vice versa.
...
<p class="display-3">10. Información Personal de Menores<p>

<p class="display-3">Nuestros servicios están dirigidos principalmente a comerciantes, emprendedores y empresas, no así a menores de 18 años. Si nos enteramos de que la información que recopilamos fue proporcionada por un menor de 18 años, eliminaremos esa información de inmediato.</p>

 
<p class="display-3">11. ¿Cómo podés ejercer tus derechos para controlar tu información personal?</p>
...
Podrás hacer consultas y/o peticiones relativas a tu información personal desde Mis derechos de Privacidad o a través de los datos de contacto provistos en los anexos de cada país incluidos debajo.</p>

<p class="display-3">12. Cambios en la Declaración de Privacidad </p>

<p>INFOCAM SAS realizará actualizaciones periódicas de la Declaración de Privacidad para reflejar los cambios constantes en los servicios que ofrecemos. Estas actualizaciones reflejarán de manera transparente la forma en que la información personal es tratada. Te notificaremos de estos cambios por nuestros canales habituales, como el correo electrónico o mensajes a través de las aplicaciones. En los casos que corresponda, recabaremos tu consentimiento. </p>/

 
<p class="display-3">13. Ley Aplicable y Jurisdicción</p>

<p>La Declaración de Privacidad se regirá por las leyes de la República Argentina. Ante cualquier controversia o divergencia relacionada con la interpretación, validez, celebración o cumplimiento de la presente Declaración de Privacidad, se resolverá por los tribunales competentes indicados debajo.
...
Esta Declaración de Privacidad se regirá por las leyes de la República Argentina. Ante cualquier controversia o divergencia relacionada con la interpretación, validez, celebración o cumplimiento de las mismas, tú y INFOCAM SAS declaran que se someten a la jurisdicción exclusiva de los Tribunales con asiento en la Ciudad de Córdoba, renunciando expresamente a cualquier otro fuero y/o jurisdicción que pudiera corresponderles.</p> 
      </div>
    </div>
  </div>
</div>
